    ...
    <div class="container">
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="collapse  navbar-collapse" id="readable-navbar-collapse">
                <ul class="navigation">
                    <li class="main">
                        <a href="{{ route('main.index') }}" class="dropdown-toggle" data-toggle="dropdown">Главная</a>
                    </li>
                    <li class="about">
                        <a href="{{ route('main.about') }}" class="dropdown-toggle" data-toggle="dropdown">Кто я?</a>
                    </li>
                    <li class="feedback">
