<div class="widget-author widget-auth-form boxed">
    <div class="row">
        <div class="col-xs-10  col-xs-offset-1">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('auth.loginPost') }}">
                {{ csrf_field() }}
                ...
                <div class="push-down-30">
                    Еще не зарегистрированы? <a href="{{ route('auth.register') }}" style="cursor: pointer">Зарегистрироваться</a>
                </div>
            </form>
        </div>
    </div>
